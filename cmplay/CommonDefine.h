...
typedef INT32 (*PF_RTP_LOGIN_CALLBACK)(int resultCode, char* resultString,PT_VIDEO_INFO ptVideoInfo, void *pUserData);
typedef INT32 (*PF_RTP_SET_VIDEO_DATA_CALLBACK)(PT_FRAME_INFO ptFrameInfo, PT_VIDEO_INFO ptVideoInfo,void *pUserData);
