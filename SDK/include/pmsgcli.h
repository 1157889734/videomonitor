...
typedef struct _T_NVR_SEARCH_RECORD
{
    ...
    INT8 iCarriageNo;
    INT8 iIpcPos;
}  T_NVR_SEARCH_RECORD, *PT_NVR_SEARCH_RECORD;

typedef struct _T_PTZ_OPT
{
    __int8 i8CtrlType;
    INT8 i8MoveType;
}  T_PTZ_OPT, *PT_PTZ_OPT;

typedef struct _T_PRESET_OPT
{
    INT8 i8CtrlType;
    INT8 i8PresetNo;
}  T_PRESET_OPT, *PT_PRESET_OPT;
